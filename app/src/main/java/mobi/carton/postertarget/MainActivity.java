...
public class MainActivity extends CartonActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutParams.x = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_MM, 25, dm);
        layoutParams.y = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_MM, 25, dm);
