...
public class SampleAppMenuGroup
{
    ...
    CompoundButton.OnCheckedChangeListener mOnRadioCheckedListener;
                              ...
                              int width)
    {
        ...
        mOnCheckedListener = new CompoundButton.OnCheckedChangeListener()
        {
        ...
        mOnRadioCheckedListener = new CompoundButton.OnCheckedChangeListener()
        {
